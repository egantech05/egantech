                ...
                <div className={`flex items-center gap-6 flex-wrap ${align === 'center' ? 'justify-center' : 'justify-start'
                    ...
                    {technologies.map(tech => (
                        ...
                        >
                            ...
                            {/* Tooltip */}
                            {showTooltip && (
                                <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 px-2 py-1 bg-gray-500 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-10">
                                    {tech.name}
                                </div>
                            )}
                        </div>

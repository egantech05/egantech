            ...
            <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <nav className="flex items-center gap-3">
                    <Link
                        ...
                        className="rounded-full border border-gray-300 flex items-center justify-center text-gray-400 hover:text-gray-900 hover:border-gray-900 transition-colors"
                    >
